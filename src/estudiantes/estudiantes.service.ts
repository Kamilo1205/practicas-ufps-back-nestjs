...
export class EstudiantesService {
  ...
  findAll(query: PaginateQuery) {
    return paginate(query, this.estudianteRepository, {
      ...
      relations: ['usuario', 'grupoMatriculado', 'ciudadResidencia', 'eps', 'lugarExpedicionDocumento', 'tipoAfiliacionEps', 'tipoDocumento', 'estudianteAreaInteres', 'herramientas', 'semestres', 'asignaciones', 'asignaciones.solicitud', 'asignaciones.solicitud.semestre', 'planesDeTrabajo'],
      withDeleted: true,
      filterableColumns: {
