...
export class EstudiantesService {
  ...
  findAll(query: PaginateQuery) {
    return paginate(query, this.estudianteRepository, {
      ...
      relations: ['usuario', 'grupoMatriculado', 'ciudadResidencia', 'eps', 'lugarExpedicionDocumento', 'tipoAfiliacionEps', 'tipoDocumento', 'estudianteAreaInteres', 'herramientas', 'semestres', 'asignaciones', 'asignaciones.tutor', 'asignaciones.solicitud', 'asignaciones.solicitud.semestre', 'asignaciones.planDeTrabajo', 'planesDeTrabajo'],
      withDeleted: true,
      filterableColumns: {
